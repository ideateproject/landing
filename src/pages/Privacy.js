	...
	return (
		<div className="privacy">
			<div className="privacy__header">
				<div id="nav" className="privacy__navbar">
					<ul className="privacy__navbarLeft">
						<li>
							<img
								onClick={homeroute}
								src={ideate_logo}
					...
					<ul className="privacy__navbarRight">
						<li>
			...
			<div className="privacy__main">
				...
				<p>
					...
					<span>Company</span> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Ideate Project Inc., 2518 E 17th Street Tulsa, OK 74104.<br />
					...
					<span>Country</span> refers to: Delaware, United States<br />
					<span>Data Controller</span >, for the purposes of the GDPR (General Data Protection Regulation), refers to the Company as the legal person which alone or jointly with others determines the purposes and means of the processing of Personal Data.<br />
					...
					<span> Service</span > refers to the Website.<br />
					...
					<span> Third - party Social Media Service</span > refers to any website or any social network website through which a User can log in or create an account to use the Service.<br />
					...
					<span> Website</span > refers to The Ideate Project, accessible from https://www.ideateproject.com/<br />
					...
					Under GDPR (General Data Protection Regulation), You can be referred to as the Data Subject or as the User as you are the individual using the Service.<br />
				</p>
				<br />
				<br />
				...
				<p>
					<h3>Personal Data</h3>
						...
						&emsp; First name and last name<br />
						&emsp; Address, State, Province, ZIP/Postal code, City
					<br />
					<br />
					<h3>Usage Data</h3>
						Usage Data
				...
				<br />
				<ul>
					<li><span>Consent</span>: You have given Your consent for processing Personal Data for one or more specific purposes.</li>
					<li><span>Performance of a contract</span>: Provision of Personal Data is necessary for the performance of an agreement with You and/or for any pre-contractual obligations thereof.</li>
					<li><span>Legal obligations</span>: Processing Personal Data is necessary for compliance with a legal obligation to which the Company is subject.</li>
					<li><span>Vital interests</span>: Processing Personal Data is necessary in order to protect Your vital interests or of another natural person.</li>
					<li><span>Public interests</span>: Processing Personal Data is related to a task that is carried out in the public interest or in the exercise of official authority vested in the Company.</li>
					<li><span>Legitimate interests</span>: Processing Personal Data is necessary for the purposes of the legitimate interests pursued by the Company.</li>
				</ul>
				<br />
				...
				<br />
				<ul>
					<li><span>Request access to Your Personal Data</span>. The right to access, update or delete the information We have on You. Whenever made possible, you can access, update or request deletion of Your Personal Data directly within Your account settings section. If you are unable to perform these actions yourself, please contact Us to assist You. This also enables You to receive a copy of the Personal Data We hold about You.</li>
					<li><span>Request correction of the Personal Data that We hold about You</span>. You have the right to to have any incomplete or inaccurate information We hold about You corrected.</li>
					<li><span>Object to processing of Your Personal Data</span>. This right exists where We are relying on a legitimate interest as the legal basis for Our processing and there is something about Your particular situation, which makes You want to object to our processing of Your Personal Data on this ground. You also have the right to object where We are processing Your Personal Data for direct marketing purposes.</li>
					<li><span>Request erasure of Your Personal Data</span>. You have the right to ask Us to delete or remove Personal Data when there is no good reason for Us to continue processing it.</li>
					<li><span>Request the transfer of Your Personal Data</span>. We will provide to You, or to a third-party You have chosen, Your Personal Data in a structured, commonly used, machine-readable format. Please note that this right only applies to automated information which You initially provided consent for Us to use or where We used the information to perform a contract with You.</li>
					<li><span>Withdraw Your consent</span>. You have the right to withdraw Your consent on using your Personal Data. If You withdraw Your consent, We may not be able to provide You with access to certain specific functionalities of the Service.</li>
				</ul>
				<br />
				<br />
				...
				<br />
				<p>
				<br /><span>Category A: Identifiers.</span><br />
							Examples: A real name, alias, postal address, unique personal identifier, online identifier, Internet Protocol address, email address, account name, driver's license number, passport number, or other similar identifiers.
				<br />	
					Collected: Yes.
				<br /><span>Category B: Personal information categories listed in the California Customer Records statute (Cal. Civ. Code § 1798.80(e)).</span><br />
							Examples: A name, signature, Social Security number, physical characteristics or description, address, telephone number, passport number, driver's license or state identification card number, insurance policy number, education, employment, employment history, bank account number, credit card number, debit card number, or any other financial information, medical information, or health insurance information. Some personal information included in this category may overlap with other categories.
							Collected: Yes.
							<br /><span>Category C: Protected classification characteristics under California or federal law.</span ><br />
							Examples: Age (40 years or older), race, color, ancestry, national origin, citizenship, religion or creed, marital status, medical condition, physical or mental disability, sex (including gender, gender identity, gender expression, pregnancy or childbirth and related medical conditions), sexual orientation, veteran or military status, genetic information (including familial genetic information).
				<br />
							Collected: No.
							<br /><span>Category D: Commercial information.</span ><br />
							Examples: Records and history of products or services purchased or considered.
				<br />
							Collected: No.
							<br /><span>Category E: Biometric information.</span ><br />
							Examples: Genetic, physiological, behavioral, and biological characteristics, or activity patterns used to extract a template or other identifier or identifying information, such as, fingerprints, faceprints, and voiceprints, iris or retina scans, keystroke, gait, or other physical patterns, and sleep, health, or exercise data.
				<br />
							Collected: No.
							<br /><span>Category F: Internet or other similar network activity.</span ><br />
							Examples: Interaction with our Service or advertisement.
				<br />
							Collected: Yes.
							<br /><span>Category G: Geolocation data.</span ><br />
							Examples: Approximate physical location.
				<br />
							Collected: No.
							<br /><span>Category H: Sensory data.</span ><br />
							Examples: Audio, electronic, visual, thermal, olfactory, or similar information.
				<br />
							Collected: No.
							<br /><span>Category I: Professional or employment - related information.</span ><br />
							Examples: Current or past job history or performance evaluations.
				<br />
							Collected: No.
							<br /><span>Category J: Non - public education information(per the Family Educational Rights and Privacy Act(20 U.S.C.Section 1232g, 34 C.F.R.Part 99)).</span ><br />
							Examples: Education records directly related to a student maintained by an educational institution or party acting on its behalf, such as grades, transcripts, class lists, student schedules, student identification codes, student financial information, or student disciplinary records.
				<br />
							Collected: No.
							<br /><span>Category K: Inferences drawn from other personal information.</span ><br />
				...
				<br />
				<ul>
					<li><span>Directly from You</span>. For example, from the forms You complete on our Service, preferences You express or provide through our Service.</li>
					<li><span>Indirectly from You</span>. For example, from observing Your activity on our Service.</li>
					<li><span>Automatically from You</span>. For example, through cookies We or our Service Providers set on Your Device as You navigate through our Service.</li>
					<li><span>From Service Providers</span>. For example, or other third-party vendors that We use to provide the Service to You.</li>
				</ul>
				<br />
				<br />
